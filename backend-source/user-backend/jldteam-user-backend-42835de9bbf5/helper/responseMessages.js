const messages = {
    "eng": {
        session: {
            expire: 'Your session has been expired please login again.'
        },
        newUser: {
            ...
            alreadyExistEmail: 'Email already exists, Try registering with different email.',
            alreadyExistPhone: 'Phone number already in use, please enter a new phone number',
        },
        user: {
        ...
        login: {
            ...
            invalid_credentials: 'Incorrect password! Try again or click Forgot password to reset it',
    ...
    "kor": {
        session: {
            expire: '세션이 만료되었습니다 다시 로그인하십시오.'
        },
        newUser: {
            success: '계정이 성공적으로 생성되었습니다. 이메일을 확인하십시오.',
            error: '내부 서버 오류 계정을 만들 수 없습니다. \n 다시 시도하십시오',
            alreadyExist: '쿠폰 토크 토크에 이미 등록되어 있습니다.',
            alreadyExistEmail: '이메일이 이미 존재합니다. 다른 이메일로 등록 해보십시오.',
            alreadyExistPhone: '이미 사용중인 전화 번호입니다. 새 전화 번호를 입력하십시오',
        },
        user: {
        ...
        login: {
            ...
            invalid_credentials: '잘못된 비밀번호! 다시 시도하거나 비밀번호 찾기를 클릭하여 재설정하십시오.',
