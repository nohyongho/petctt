...
const sg = sendGrid(keys.sendGrid.apiKey);
...
const sendResetEmail = async (email, code) => {
	// const link = `${host_address}:${host_port}/user/verify/resetPassword/${email}/${code}`;
	// const body = ejs.render(emailResetTemplate, { link });
	// const body = link;
	// await sendEmail(body, email, 'Coin Hunter Reset Password');
};
